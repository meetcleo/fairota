...
class RotationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rotation" do
    assert_difference("Rotation.count") do
      post rotations_url, params: { rotation: { description: @rotation.description, title: @rotation.title } }
    end
  ...
  test "should update rotation" do
    patch rotation_url(@rotation), params: { rotation: { description: @rotation.description, title: @rotation.title } }
